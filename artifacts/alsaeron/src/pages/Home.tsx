...
function ProductShape({ shape }: { shape: string }) {
  if (shape === "circle") {
    return (
      <div className="relative w-36 h-36 md:w-44 md:h-44 flex items-center justify-center">
        ...
        <div className="absolute inset-8 rounded-full bg-primary/5 backdrop-blur-sm" />
        <div
          className="absolute inset-0 rounded-full"
          style={{
            background:
              "conic-gradient(from 0deg, transparent 70%, rgba(37,99,235,0.4) 85%, transparent 100%)",
          }}
        />
        <div className="w-3 h-3 rounded-full bg-primary/60 shadow-[0_0_20px_rgba(37,99,235,0.8)]" />
      </div>
    );
  }
  if (shape === "diamond") {
    return (
      <div className="relative w-36 h-36 md:w-44 md:h-44 flex items-center justify-center">
        ...
        <div className="w-28 h-28 border border-primary/20 rotate-45 absolute" />
        <div className="w-12 h-12 rotate-45 absolute bg-primary/8 backdrop-blur-sm" />
        <div
  ...
  return (
    <div className="relative w-36 h-36 md:w-44 md:h-44 flex items-center justify-center">
      ...
      <div
        className="w-4 h-4 rounded-sm rotate-12"
        style={{
          background: "rgba(14,165,233,0.9)",
          boxShadow: "0 0 24px rgba(14,165,233,1)",
        }}
      />
    </div>
  );
...
function ProductCard({
  ...
  return (
    ...
    >
      <div
        className="relative aspect-[3/4] mb-6 md:mb-8 overflow-hidden flex items-center justify-center"
        style={{
      ...
      >
        ...
        <div
          ...
          style={{
            boxShadow: `inset 0 0 60px ${product.glowColor}`,
          }}
        />

        <div
          className="absolute inset-0 border border-transparent group-hover:border-primary/20 transition-all duration-700 pointer-events-none"
          style={{
        ...
        <div
          ...
          style={{
            boxShadow: `0 0 40px -10px ${product.glowColor}`,
      ...
      <div className="space-y-3 px-1">
        <p className="text-[9px] tracking-[0.3em] text-primary/70 font-sans uppercase">
          {product.category}
        </p>
...
export default function Home() {
  ...
  const heroY = useSpring(useTransform(heroScroll, [0, 1], [0, 140]), {
    stiffness: 60,
    damping: 30,
  });
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 60% at 50% 55%, rgba(37,99,235,0.09) 0%, transparent 70%)",
            }}
          />
          <motion.div
        ...
        >
          ...
          <div className="overflow-hidden mb-4 md:mb-6">
            <motion.h1
              ...
              style={{
                textShadow:
                  "0 0 80px rgba(37,99,235,0.15), 0 0 200px rgba(37,99,235,0.08)",
              }}
          ...
          >
            <p
              className="text-lg md:text-2xl font-serif font-light text-white/50 italic tracking-wide"
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, rgba(37,99,235,0.6), transparent)",
              }}
            />
          </motion.div>
        </motion.div>
        ...
        >
          <span className="text-[9px] tracking-[0.35em] text-white/25 font-sans uppercase">
            Scroll
          </span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
      ...
      <section className="py-24 md:py-40 relative" id="heritage">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(37,99,235,0.04) 0%, transparent 70%)",
          }}
        />
        <div className="container mx-auto px-6 md:px-16 max-w-5xl">
          <div className="border-t border-white/5 pt-16 md:pt-24">
            <FadeIn className="max-w-3xl">
              <p className="text-[10px] tracking-[0.3em] text-primary/60 font-sans uppercase mb-6 md:mb-8">
                Our Philosophy
              </p>
        ...
        <div className="container mx-auto px-6 md:px-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x divide-white/5">
            {stats.map((stat, i) => (
              ...
              >
                <p className="text-3xl md:text-4xl font-serif text-white mb-2 tracking-wider">
                  {stat.value}
                </p>
                <p className="text-[9px] tracking-[0.25em] text-muted-foreground uppercase font-sans">
                  {stat.label}
                </p>
              </FadeIn>
            ))}
      ...
      <section id="collections" className="py-24 md:py-40">
        <div className="container mx-auto px-6 md:px-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-6">
            <FadeIn>
              <p className="text-[10px] tracking-[0.3em] text-primary/60 font-sans uppercase mb-4 md:mb-5">
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(37,99,235,0.08) 0%, rgba(99,102,241,0.04) 40%, transparent 70%)",
              filter: "blur(40px)",
            }}
          />
        </motion.div>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <FadeIn>
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, transparent, rgba(37,99,235,0.5), transparent)",
              }}
            />
            <p className="text-[10px] tracking-[0.35em] text-primary/50 font-sans uppercase mb-6 md:mb-8">
              Bespoke Commission
            </p>
        ...
        <div className="container mx-auto px-6 md:px-16">
          <div className="max-w-xl mx-auto">
            <FadeIn className="text-center mb-12 md:mb-16">
              <p className="text-[10px] tracking-[0.3em] text-primary/60 font-sans uppercase mb-4 md:mb-6">
                Inner Circle
              </p>
            ...
            <FadeIn delay={0.12}>
              <div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, rgba(37,99,235,0.04) 0%, rgba(0,0,0,0) 100%)",
                }}
              >
                <div
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full mt-2 py-4 md:py-5 text-[10px] tracking-[0.25em] font-sans uppercase transition-all duration-700 cursor-pointer"
                    style={{
